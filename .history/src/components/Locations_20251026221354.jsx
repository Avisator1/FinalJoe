...
function FeaturedLocations() {
  ...
  return (
    <section id='trips' className="bg-white mx-auto me max-w-[115rem] px-10 py-32">
      {/* Header */}
      <div className="mb-20">
          ...
          >
            <div className="relative overflow-hidden shadow-lg">
              <img
                src={location.image}
                alt={location.name}
                className="w-[600px] h-[650px] grayscale-0 hover:grayscale-0-0 transition object-cover duration-500 group-hover:scale-105"
              />
            </div>
            <div className="mt-4">
