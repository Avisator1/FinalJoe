    ...
    <section className="relative me bg-white mx-auto max-w-[115rem] px-4 sm:px-6 md:px-10 py-16 md:py-32">
      <div className="flex flex-col md:flex-row items-start gap-8 md:gap-12">
        ...
        <div className="md:w-1/2">
          ...
          <h2 className="text-4xl sm:text-6xl md:text-[130px] font-[580] leading-none mb-6 md:mb-8 text-black">
            Photography
          </h2>
          <p className="text-lg sm:text-xl md:text-3xl text-black leading-snug max-w-xl mb-12 md:mb-16">
          ...
          <div className="mt-8 md:mt-10">
            ...
            <ul className="text-base sm:text-lg md:text-2xl text-black font-[500] leading-relaxed space-y-1 md:space-y-2">
              <li>SONY A7CR</li>
              <li>SONY ZV-E10</li>
        ...
        {/* RIGHT IMAGES - Desktop layout */}
        <div className="hidden md:block md:w-1/2 relative flex flex-col items-end">
        ...
        {/* MOBILE IMAGES - Simple stacked layout */}
