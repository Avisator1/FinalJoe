...
function Hero() {
  return (
    <>
      ...
      <div className="md:hidden relative bg-white  flex flex-col items-center justify-center">
        {/* Centered Image */}
        <div className="ite justify-center">
          <img
            src={joe}
            alt="joe mcdavid"
        ...
        {/* Centered Text */}
        <div className=" items-start justify-center pt-8">
          <ScreenFitText>
            Joe McDavid
          </ScreenFitText>
        </div>
