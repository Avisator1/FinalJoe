        ...
        <>
          ...
          <nav className="hidden md:block fixed mix-blend-difference backdrop-blur-md transition-all duration-500 top-2 left-1/2 -translate-x-1/2 w-[calc(100%-4rem)] max-w-[112rem] rounded-lg px-8 z-[999999]">
            <div className="flex items-center justify-between py-3 relative z-[60]">
              ...
              {/* Center - Subtitle */}
              <div className="text-lg font-[500] tracking-wide text-white absolute left-1/2 -translate-x-1/2 me">
                Photographer
              </div>

              {/* Right - Links */}
              <div className="flex items-center gap-8 font-[500] text-white text-lg tracking-wide me">
                <Link
                  to="/"
                  smooth
                  className="hover:bg-white hover:text-black px-4 py-2 rounded-full transition duration-150 me"
                >
                  Home
                </Link>
                ...
                <Link
                  to="/#contact"
                  smooth
                  className="group hover:bg-white hover:text-black px-4 py-2 rounded-full transition duration-150 flex items-center gap-2 me"
                >
                  Contact
                  <svg
                ...
                <button
                  className="text-white text-lg hover:bg-white hover:text-black py-2 px-4 cursor-pointer rounded-full me"
          ...
          <nav className="md:hidden fixed backdrop-blur-sm bg-white/50 border border-white/10 transition-all duration-500 top-2 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] rounded-lg px-6 z-[999999]">
            <div className="flex items-center justify-between py-3">
              {/* Left - Logo */}
              <a href="/" className="text-xl font-[500] tracking-wide text-black me">
                Joe Mcdavid
              </a>

              {/* Mobile Menu Toggle */}
              <button
                className="text-black text-2xl me"
                onClick={() => setMenuOpen(!menuOpen)}
                aria-label="Toggle Menu"
              >
                <FiMenu size={24} />
        ...
        <div className="fixed inset-0 z-[999998] flex flex-col">
          ...
          <div className="relative z-10 flex flex-col h-full animate-slideUp">
            ...
            <div className="flex items-center justify-between px-8 py-6 border-b border-gray-800/50 relative z-20">
              <div className="text-2xl font-[500] text-white me">Joe Mcdavid</div>
              <button
                className="text-white text-2xl hover:text-gray-300 transition-colors me"
                  ...
                  {menuItems.map((item, index) => (
                    ...
                    >
                      <Link
                        ...
                        smooth
                        onClick={closeMenu}
                        className="block text-4xl md:text-5xl lg:text-6xl xl:text-6xl font-[400] py-4 md:py-6 text-white hover:text-gray-300 transition-all duration-300 text-left hover:pl-4 flex-1 me"
                      >
                        {item.name}
                      </Link>

                      <span className="text-white text-xl md:text-2xl font-[400] pr-4 me">
