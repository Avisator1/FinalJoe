...
function Scotland() {
  const scotlandImages = [
    ...
    { src: "https://photos.adiavi.com/images/scotland/11.jpg", width: 560, height: 390, rotation: 3, span: '' },
    { src: "https://photos.adiavi.com/images/scotland/12.jpg", width: 370, height: 520, rotation: -1, span: 'md:col-span-2' },
    { src: "https://photos.adiavi.com/images/scotland/13.jpg", width: 540, height: 370, rotation: 2, span: '' },
    { src: "https://photos.adiavi.com/images/scotland/14.jpg", width: 390, height: 540, rotation: -2, span: '' },
    { src: "https://photos.adiavi.com/images/scotland/15.jpg", width: 480, height: 320, rotation: 1, span: 'lg:col-span-2' },
    { src: "https://photos.adiavi.com/images/scotland/16.jpg", width: 420, height: 590, rotation: -3, span: '' },
    { src: "https://photos.adiavi.com/images/scotland/17.jpg", width: 580, height: 400, rotation: 2, span: 'md:col-span-2' },
  ];
      ...
      <section className="bg-white me mx-auto max-w-[115rem] px-4 sm:px-6 md:px-10 py-16 md:py-32">
        ...
        <div className="mb-12 mt-20 md:mb-20">
          <div className="flex items-center gap-3 md:gap-4 mb-4">
            ...
            <p className="text-lg md:text-xl tracking-wide text-gray-800">SCOTLAND COLLECTION</p>
          </div>
