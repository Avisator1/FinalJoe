...
function Club() {
  const clubImages = [
    ...
    { src: "https://photos.adiavi.com/images/club/15.jpg", width: 520, height: 350, rotation: 1, span: '' },
    { src: "https://photos.adiavi.com/images/club/16.jpg", width: 380, height: 570, rotation: -2, span: '' },
    { src: "https://photos.adiavi.com/images/club/17.jpg", width: 450, height: 300, rotation: 3, span: 'md:col-span-2' },
    { src: "https://photos.adiavi.com/images/club/18.jpg", width: 580, height: 390, rotation: 1, span: '' },
    { src: "https://photos.adiavi.com/images/club/19.jpg", width: 340, height: 510, rotation: -3, span: 'lg:col-span-2' },
    { src: "https://photos.adiavi.com/images/club/20.jpg", width: 490, height: 330, rotation: 2, span: '' },
    { src: "https://photos.adiavi.com/images/club/21.jpg", width: 410, height: 590, rotation: -1, span: '' },
    { src: "https://photos.adiavi.com/images/club/22.jpg", width: 530, height: 360, rotation: 4, span: 'md:col-span-2' },
    { src: "https://photos.adiavi.com/images/club/23.jpg", width: 370, height: 520, rotation: -2, span: '' },
    { src: "https://photos.adiavi.com/images/club/24.jpg", width: 460, height: 310, rotation: 1, span: '' },
    { src: "https://photos.adiavi.com/images/club/25.jpg", width: 600, height: 400, rotation: -3, span: 'lg:col-span-2' },
    { src: "https://photos.adiavi.com/images/club/26.jpg", width: 320, height: 480, rotation: 2, span: '' },
    { src: "https://photos.adiavi.com/images/club/27.jpg", width: 540, height: 370, rotation: -1, span: '' },
    { src: "https://photos.adiavi.com/images/club/28.jpg", width: 390, height: 540, rotation: 3, span: 'md:col-span-2' },
    { src: "https://photos.adiavi.com/images/club/29.jpg", width: 520, height: 350, rotation: -2, span: '' },
    { src: "https://photos.adiavi.com/images/club/30.jpg", width: 380, height: 570, rotation: 1, span: 'lg:col-span-2' }
  ];
      ...
      <section className="bg-white mx-auto me max-w-[115rem] px-4 sm:px-6 md:px-10 py-16 md:py-32">
        ...
        <div className="mb-12 mt-20 md:mb-20">
          <div className="flex items-center gap-3 md:gap-4 mb-4">
            ...
            <p className="text-lg md:text-xl tracking-wide text-gray-800">CLUB COLLECTION</p>
          </div>
          <h2 className="text-7xl sm:text-7xl lg:text-[200px] font-[580] leading-none mb-6 md:mb-8 text-black">
            Club
          </h2>
