...
function Flowers() {
  ...
  // Generate 24 flower images dynamically
  const flowersImages = Array.from({ length: 24 }, (_, i) => ({
    src: `https://photos.adiavi.com/images/flowers/${i + 1}.jpg`,
    width: Math.floor(Math.random() * 300) + 350, // 350–650 width
    height: Math.floor(Math.random() * 200) + 350, // 350–550 height
    rotation: Math.floor(Math.random() * 10) - 5,  // -5° to +5°
    span:
      Math.random() > 0.8
        ? 'lg:col-span-2'
        : Math.random() > 0.6
    ...
    <div>
      ...
      <section className="bg-white mx-auto me max-w-[115rem] px-4 sm:px-6 md:px-10 py-16 md:py-32">
        ...
        <div className="mb-12 md:mb-16">
          <p className="text-base md:text-lg tracking-wide text-gray-700 mb-2 uppercase">Shot With</p>
        ...
        <div className="mt-12 md:mt-20 pt-8 md:pt-10 border-t border-gray-200">
          ...
          <div className="mt-8 md:mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 pt-8 border-t border-gray-200">
            <div>
              ...
              <p className="text-lg md:text-2xl text-black font-[500]">Macro & Natural Light</p>
            </div>
            <div>
              <p className="text-base md:text-lg tracking-wide text-gray-700 mb-2 uppercase">Season</p>
              <p className="text-lg md:text-2xl text-black font-[500]">Spring & Summer</p>
            </div>
            <div>
              <p className="text-base md:text-lg tracking-wide text-gray-700 mb-2 uppercase">Focus</p>
              <p className="text-lg md:text-2xl text-black font-[500]">Color & Texture</p>
            </div>
          </div>
        </div>
