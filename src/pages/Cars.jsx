      ...
      <section className="bg-white mx-auto max-w-[115rem] px-10 py-32">
        ...
        <div className="mt-20 pt-10 border-t border-gray-200">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 pt-8 border-t border-gray-200">
            <div>
              <p className="text-lg tracking-wide text-gray-700 mb-2 uppercase">Photography Style</p>
              <p className="text-2xl text-black font-[500]">Detail & Atmosphere</p>
            </div>
            <div>
              <p className="text-lg tracking-wide text-gray-700 mb-2 uppercase">Lighting</p>
              <p className="text-2xl text-black font-[500]">Golden Hour & Studio</p>
            </div>
            <div>
              <p className="text-lg tracking-wide text-gray-700 mb-2 uppercase">Focus</p>
              <p className="text-2xl text-black font-[500]">Design & Emotion</p>
            </div>
          </div>
        </div>
