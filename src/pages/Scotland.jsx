...
function Scotland() {
  const scotlandImages = [
    { src: scotland1, width: 580, height: 390, rotation: -3, span: 'md:col-span-2' },
    { src: scotland2, width: 420, height: 620, rotation: 2, span: '' },
    { src: scotland3, width: 520, height: 350, rotation: 1, span: '' },
    { src: scotland4, width: 380, height: 540, rotation: -2, span: 'lg:col-span-2' },
    { src: scotland5, width: 460, height: 310, rotation: 3, span: '' },
    { src: scotland6, width: 600, height: 400, rotation: -1, span: 'md:col-span-2' },
    { src: scotland7, width: 340, height: 510, rotation: 2, span: '' },
    { src: scotland8, width: 490, height: 330, rotation: -3, span: '' },
    { src: scotland9, width: 530, height: 360, rotation: 1, span: 'lg:col-span-2' },
    { src: scotland10, width: 410, height: 580, rotation: -2, span: '' }
  ];
