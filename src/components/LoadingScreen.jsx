...
const Preloader = ({ onFinish }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-1/2 bg-[#ecebeb]" />
      <div className="absolute bottom-0 left-0 w-full h-1/2 bg-[#ecebeb]" />
      ...
      <div className="absolute top-[48.5%] flex flex-col items-center overflow-hidden w-full">
        <div className="flex items-center justify-center w-[200px] overflow-hidden">
          {/* MANGO */}
          <h1
            className={`text-xl sm:text-2xl font-[500] me text-black tracking-wider transition-all duration-500 ease-out ${
              showMango
          ...
          {/* FX */}
          <h1
            className={`text-xl sm:text-2xl font-[500] me gurt tracking-tight transition-all duration-500 ease-out ${
              showFx
